// __tests__/mocks/mockInsuranceData.ts
// Questo file contiene una copia completa dei dati di produzione
// da usare come base stabile e prevedibile per tutti i test.
